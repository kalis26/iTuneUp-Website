    ...
    return (
        <div className="bg-white flex flex-col items-center gap-10 lg:max-w-2/3 mx-auto p-4 md:p-10">
            <div className="flex flex-col items-center">
                <h1 className={`font-semibold text-6xl md:text-7xl text-center text-[rgb(29,29,31)]`}>What&apos;s better than music?</h1>
                <h1 className={`font-semibold text-6xl md:text-7xl text-center text-[rgb(29,29,31)] pb-10`}>Music that&apos;s free.</h1>
