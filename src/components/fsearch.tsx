            ...
            <div className="flex flex-row gap-5 bg-white p-3 md:p-10 md:flex-nowrap flex-wrap lg:max-w-4/5 mx-auto w-fit">
                ...
                <div className="flex flex-col gap-5">
                    <div className="bg-[#F5F5F7] flex-1 p-6 md:p-10 text-center rounded-xl">
                        <span className={`${SfProDisplay.className} font-semibold text-base text-[#6e6e73]`}>And because iTuneUp searches the entire <strong className="text-black/90">Apple Music</strong> catalog, every album you download is matched to the official release — <strong className="text-black/90">complete</strong>, <strong className="text-black/90">organized</strong>, and <strong className="text-black/90"> exactly where it belongs</strong> in your collection.</span>
                    ...
                    <div className="bg-[#F5F5F7] flex-1 p-6 md:p-10 text-center text-base rounded-xl">
                        <div className="flex flex-col items-center">
                            <span className={`${SfProDisplay.className} font-semibold text-base text-[#6e6e73]`}>Build a new library from the ground up. Or perfect the one you already love. With iTuneUp, it’s all there. <strong className="text-black/90">Simple. Seamless. Yours.</strong></span>
                            <Image 
